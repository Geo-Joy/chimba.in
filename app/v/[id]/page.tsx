...
export async function generateMetadata({
  ...
  const description =
    ...
    "Watch this video from ChimbanumChimbiyum Kids Entertainment Channel";
  const url = `https://www.chimba.in/v/${videoId}`;
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="flex-1 bg-red-600 text-white px-6 py-3 rounded-full font-bold hover:bg-red-700 transition-all shadow-lg text-center"
              >
                Watch on YouTube
              </a>
